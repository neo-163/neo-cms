<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="文章ID" prop="id" sortable="custom" align="center" width="80" :class-name="getSortClass('id')">
      ...
      <el-table-column label="描述" width="110px" align="center" v-if="showMoreData">
        <template slot-scope="{row}">
      ...
      <el-table-column label="更新时间" width="150px" align="center" v-if="showMoreData">
        <template slot-scope="{row}">
      ...
      <el-table-column label="操作" align="center" width="300" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          ...
          <el-button v-if="row.status!='published'" size="mini" type="warning" @click="stopUsed(row,'published')">
            暂停
          </el-button>
...
<script>
import { fetchList, fetchPv, createItem, editItem, deleteItem } from '@/api/mediaCategory'
