...
use App\Services\Api\Admin\AdminRolePermission\AdminRoleService;
...
class AdminRoleController extends BaseController
{
    ...
    public function list(Request $request): JsonResponse
    {
        ...
        return AdminRoleService::list($request);
    }
    ...
    public function details(Request $request): JsonResponse
    {
        ...
        return AdminRoleService::details($request);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        $validatorResult = $this->validatorStopOnFirst($request, [
            ...
            'role_permissions' => 'nullable|array', // 角色的权限集合
        ...
        return AdminRoleService::store($request);
    }
    ...
    public function delete(Request $request): JsonResponse
    {
        ...
        return AdminRoleService::delete($request);
    }
}
